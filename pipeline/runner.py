...
def main():
    ...
    stages = [
        ...
        dict(id="GRAPH", label="assemble the project graph", llm=False, core=False,
             cmd=[py, "-u", "m5_graph.py"], need=registers_all,
             why="schedule/PO/Cx register CSVs not uploaded"),
        ...
        dict(id="M7", label="concession options + decision clock", llm=False, core=False,
